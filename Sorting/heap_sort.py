...
if __name__ == '__main__':
    ...
    print(f'Время работы алгоритма shell сортировки с шагом n_log_2_n с количеством элементов {size}:')
    print('случайный массив: ' + str(get_time_work(arr_rnd, gaps_n_log_2_n)) + ' секунды')
    print('5% элементов случайны: ' + str(get_time_work(arr_rnd_5percent, gaps_n_log_2_n)) + ' секунды')
    print()
